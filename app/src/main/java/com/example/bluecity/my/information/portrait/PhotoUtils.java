...
public class PhotoUtils {
    ...
    public static void takePicture(Fragment fragment, Uri imageUri, int requestCode) {
        ...
        if (requestCode == CODE_FACE_CAMERA_REQUEST) {
            intentCamera.putExtra("android.intent.extras.CAMERA_FACING", 1); //人脸识别开启前置
        }
     ...
     */
    @SuppressLint("NewApi")
    public static String getPath(final Context context, final Uri uri) {    //Android4.4之后选取中的图片不再返回真实的Uri，要对封装过的Uri进行解析
