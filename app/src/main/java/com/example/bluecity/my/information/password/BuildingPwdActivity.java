...
//
//public class BuildingPwdActivity extends AppCompatActivity {
...
//                SharedPreferencesUtil sharedPreferencesUtil = new SharedPreferencesUtil(BuildingPwdActivity.this,"userInfo");
//                String phoneNum = sharedPreferencesUtil.loadString("phoneNum");
//                new Thread(new ModifyPwdHttpThread(BuildingPwdActivity.this,"building",phoneNum,etOldPwd.getText().toString(),etNewPwd.getText().toString(),etConfPwd.getText().toString())).start();
//            }
//        });
//    }
//}
