...
//    }
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            Log.i("ZXingXY", String.valueOf(screenResolution.x) + " "+ String.valueOf(screenResolution.y));
            int screenResolutionX = screenResolution.x < screenResolution.y? screenResolution.x : screenResolution.y;

            int width = (int) (screenResolutionX * 0.6);
            int height = width;

            Log.i("ZXingXY", String.valueOf(width) + " "+ String.valueOf(height));
            /*水平居中  偏上显示*/
            ...
            Log.i("ZXingXY", String.valueOf(framingRect.left) + " "+ String.valueOf(framingRect.top)+ " "+ String.valueOf(framingRect.right)+ " "+ String.valueOf(framingRect.bottom));
            Log.i("ZXingXY", String.valueOf(leftOffset) + " "+ String.valueOf(topOffset)+ " "+ String.valueOf(width)+ " "+ String.valueOf(height));
        }
        return framingRect;
    }
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
        ...
        if (config.isFullScreenScan()) {
            Log.i("ZXing Full", String.valueOf(width) + " " +String.valueOf(height) + " " +String.valueOf(rect.left) + " " + String.valueOf(rect.top) + " " + String.valueOf(rect.width()) + " " +String.valueOf(rect.height()) + " ");
            ...
            Log.i("ZXing", String.valueOf(width) + " " +String.valueOf(height) + " " +String.valueOf(rect.left) + " " + String.valueOf(rect.top) + " " + String.valueOf(rect.width()) + " " +String.valueOf(rect.height()) + " ");
